...
public class ProdutoController {
	...
	@GetMapping("/{id}")
	public ResponseEntity<Produto> getById(@PathVariable 
	Long id ){
	...
	@PostMapping
	public ResponseEntity<Produto> inserirCategoria(@Valid @RequestBody Produto produto){
		return ResponseEntity.status(HttpStatus.CREATED)
                .body(repository.save(produto));
	}
	
	@PutMapping
	public ResponseEntity<Produto> atualizarCategoria(@RequestBody Produto produto){
